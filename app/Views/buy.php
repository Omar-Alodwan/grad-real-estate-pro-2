    ...
    <div class="container lg:mt-24 mt-16">
        ...
        <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 mt-8 gap-[30px]">
            ...
            <div class="group relative lg:px-10 transition-all duration-500 ease-in-out rounded-xl bg-white dark:bg-slate-900 overflow-hidden text-center">
                ...
                <div class="mt-6">
                    <h5 class="text-xl font-medium">Free Consultation</h5>
            ...
            <div class="group relative lg:px-10 transition-all duration-500 ease-in-out rounded-xl bg-white dark:bg-slate-900 overflow-hidden text-center">
                ...
                <div class="mt-6">
                    <h5 class="text-xl font-medium">Buyer Rebate Programs</h5>
                    <p class="text-slate-400 mt-3">If the distribution of letters and 'words' is random, the reader will
                        not be distracted from making.</p>
                </div>
            </div>
            ...
            <div class="group relative lg:px-10 transition-all duration-500 ease-in-out rounded-xl bg-white dark:bg-slate-900 overflow-hidden text-center">
                ...
                <div class="mt-6">
                    <h5 class="text-xl font-medium">Save Money</h5>
                    <p class="text-slate-400 mt-3">If the distribution of letters and 'words' is random, the reader will
                        not be distracted from making.</p>
                </div>
            </div>
                ...
                <div class="sticky top-20">
                    <ul class="flex-column text-center p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-700 rounded-md"
                        ...
                        <li role="presentation">
                            <button class="px-4 py-2 text-base font-medium rounded-md w-full text-white hover:text-green-600 transition-all duration-500 ease-in-out"
                                    id="letter-tab" data-tabs-target="#letter" type="button" role="tab"
                                    aria-controls="letter" aria-selected="true">Pre Approval Letter
                            </button>
                        </li>
                        <li role="presentation">
                            <button class="px-4 py-2 text-base font-medium rounded-md w-full text-white mt-3 transition-all duration-500 ease-in-out"
                                    id="schedule-tab" data-tabs-target="#schedule" type="button" role="tab"
                                    aria-controls="schedule" aria-selected="false">Schedule a Showing
                            </button>
                        </li>
                        <li role="presentation">
                            <button class="px-4 py-2 text-base font-medium rounded-md w-full text-white mt-3 transition-all duration-500 ease-in-out"
                                    id="offer-tab" data-tabs-target="#offer" type="button" role="tab"
                                    aria-controls="offer" aria-selected="false">Submit an Offer
                            </button>
                        </li>
                        <li role="presentation">
                            <button class="px-4 py-2 text-base font-medium rounded-md w-full text-white mt-3 transition-all duration-500 ease-in-out"
                                    id="inspection-tab" data-tabs-target="#inspection" type="button" role="tab"
                                    aria-controls="inspection" aria-selected="false">Property Inspection
                            </button>
                        </li>
                        <li role="presentation">
                            <button class="px-4 py-2 text-base font-medium rounded-md w-full text-white mt-3 transition-all duration-500 ease-in-out"
                                    id="appraisal-tab" data-tabs-target="#appraisal" type="button" role="tab"
                                    aria-controls="appraisal" aria-selected="false">Appraisal
                            </button>
                        </li>
                        <li role="presentation">
                            <button class="px-4 py-2 text-base font-medium rounded-md w-full text-white mt-3 transition-all duration-500 ease-in-out"
                                    id="closing-tab" data-tabs-target="#closing" type="button" role="tab"
                                    aria-controls="closing" aria-selected="false">Closing Deal
                            </button>
                        </li>
                    </ul>
                </div>

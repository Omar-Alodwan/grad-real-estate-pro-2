        ...
        <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-x-[30px] gap-y-[50px]">
            ...
            <div class="rounded-md shadow dark:shadow-gray-700 hover:shadow-md dark:hover:shadow-gray-700 duration-500 ease-in-out">
                <div class="border-b dark:border-gray-800 p-6 text-center">
                    ...
                    <h3 class="text-2xl text-green-600 font-medium mt-4">Basic</h3>
                ...
                <div class="p-6">
                    ...
                    <ul class="list-none">
                        <li class="text-slate-400 mt-2"><span class="text-green-600 text-lg mr-2"><i
                        ...
                        <li class="text-slate-400 mt-2"><span class="text-green-600 text-lg mr-2"><i
                                class="uil uil-check-circle align-middle"></i></span>Free Appointments
                        </li>
                        <li class="text-slate-400 mt-2"><span class="text-green-600 text-lg mr-2"><i
            ...
            <div class="rounded-md shadow dark:shadow-gray-700 hover:shadow-md dark:hover:shadow-gray-700 duration-500 ease-in-out">
                <div class="border-b dark:border-gray-800 p-6 text-center">
                    ...
                    <h3 class="text-2xl text-green-600 font-medium mt-4">Premium</h3>
            ...
            <div class="rounded-md shadow dark:shadow-gray-700 hover:shadow-md dark:hover:shadow-gray-700 duration-500 ease-in-out">
                <div class="border-b dark:border-gray-800 p-6 text-center">
                    ...
                    <h3 class="text-2xl text-green-600 font-medium mt-4">Business</h3>
